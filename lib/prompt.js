...
- PROMPT SPECIFICATION RULES — include in every prompt only what is grammatically necessary to answer correctly. Gender and number specifications are only ever needed for être constructions, where the past participle agrees with the subject. For avoir verbs, the past participle never changes with the subject — never add gender or number information for avoir verbs.
  For être constructions only:
...
- PROMPT PLAUSIBILITY: Every prompt must be a question or statement someone might realistically say or ask in real life — verify this before posing any prompt, simple or combined. First-person past-tense questions are especially prone to being unnatural (e.g. "Did I understand?" is not something anyone would ask themselves). If a prompt feels forced or implausible, choose a different subject, verb, or framing.
