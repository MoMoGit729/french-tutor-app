...
- A lesson should cover at least 15–20 exchanges before it feels complete. After drilling the current pattern, move naturally into variations, recombinations, and then introduce the next pattern. Keep going.
...
2. Immediately below, a coach's note — exactly 3 sentences, no heading, no bullets:
   ...
   Warm, direct, under 60 words total. Do not write "In summary", "Overall", or any closing pleasantry.`;
}
