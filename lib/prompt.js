...
- VOCABULARY: The learner has completed the Paul Noble course and is familiar with all vocabulary in both Paul Noble booklets. Treat this as the learner's existing baseline — never flag Paul Noble vocabulary as new, never supply a Paul Noble verb or word in a prompt as if the learner might not know it. Only introduce and explicitly announce vocabulary that goes genuinely beyond the Paul Noble materials.
